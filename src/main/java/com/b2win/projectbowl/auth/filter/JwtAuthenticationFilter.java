package com.b2win.projectbowl.auth.filter;


import com.b2win.projectbowl.auth.dto.LoginDto;
import com.b2win.projectbowl.auth.jwt.JwtTokenizer;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            // 아이디와 비밀번호로 UsernamePasswordAuthenticationToken을 생성합니다.
            ...
            e.printStackTrace(); // or log.error(e);
            throw e;
        }
    }
